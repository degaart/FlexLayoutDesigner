...
{
    { "width", PROPERTY_TYPE_VALUE, VALUE_PROP(Width), true },
    { "height", PROPERTY_TYPE_VALUE, VALUE_PROP(Height), true },
    { "min-width", PROPERTY_TYPE_VALUE, { .v = YGNodeStyleGetMinWidth }, "YGNodeStyleSetMinWidth", { .v = { .point =  YGNodeStyleSetMinWidth, .percent = YGNodeStyleSetMinWidthPercent, .auto_ = NULL } }, true },
    { "min-height", PROPERTY_TYPE_VALUE, { .v = YGNodeStyleGetMinHeight }, "YGNodeStyleSetMinHeight", { .v = { .point =  YGNodeStyleSetMinHeight, .percent = YGNodeStyleSetMinHeightPercent, .auto_ = NULL } }, true },
    { "max-width", PROPERTY_TYPE_VALUE, { .v = YGNodeStyleGetMaxWidth }, "YGNodeStyleSetMaxWidth", { .v = { .point =  YGNodeStyleSetMaxWidth, .percent = YGNodeStyleSetMaxWidthPercent, .auto_ = NULL } }, true },
    { "max-height", PROPERTY_TYPE_VALUE, { .v = YGNodeStyleGetMaxHeight }, "YGNodeStyleSetMaxHeight", { .v = { .point =  YGNodeStyleSetMaxHeight, .percent = YGNodeStyleSetMaxHeightPercent, .auto_ = NULL } }, true },
    { "flex", PROPERTY_TYPE_FLOAT, FLOAT_PROP(Flex), false },
    { "flex-grow", PROPERTY_TYPE_FLOAT, FLOAT_PROP(FlexGrow), false },
    { "flex-shrink", PROPERTY_TYPE_FLOAT, FLOAT_PROP(FlexShrink), false },
    { "basis", PROPERTY_TYPE_VALUE, VALUE_PROP(FlexBasis), true },
    { "position", PROPERTY_TYPE_EDGE_VALUE, { .ev = YGNodeStyleGetPosition }, "YGNodeStyleSetPosition", { .ev = { .point = YGNodeStyleSetPosition, .percent = YGNodeStyleSetPositionPercent, .auto_ = NULL } }, true },
    { "flex-direction", PROPERTY_TYPE_DIRECTION, DIRECTION_PROP(FlexDirection) },
    { "margin", PROPERTY_TYPE_EDGE_VALUE, EDGE_VALUE_PROP(Margin), true },
    { "padding", PROPERTY_TYPE_EDGE_VALUE, { .ev = YGNodeStyleGetPadding }, "YGNodeStyleSetPadding", { .ev = { .point = YGNodeStyleSetPadding, .percent = YGNodeStyleSetPaddingPercent, .auto_ = NULL } }, true },
    { "border", PROPERTY_TYPE_EDGE_FLOAT, EDGE_FLOAT_PROP(Border), true },
    ...
    { "aspect-ratio", PROPERTY_TYPE_FLOAT, FLOAT_PROP(AspectRatio), false },
